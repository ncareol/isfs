...
/**
 * Proxy for DataClients that are QWidgets. In QtJambi, there is
 * a restriction on QWidgets, in that they can only be used
...
public class QProxyDataClient implements DataClient
{
     ...
     */
    private static ArrayList<ProxyCache> _receiveQueue =
